...
CREATE TABLE `ticketsystem` (
  ...
  KEY `fk_ticketsystem_user_idx` (`userID`),
  CONSTRAINT `fk_ticketsystem_user` FOREIGN KEY (`userID`) REFERENCES `user` (`userID`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2024-03-22  9:12:55
